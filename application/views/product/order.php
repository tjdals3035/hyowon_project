...
<form action="payment" method="post" name="fr" onsubmit="return check()">
   ...
   <div class="shopping-cart-reform">
    　<input type="hidden" name="pname" value="<?=$item_row->product_name?>">
      <div class="item">
        ...
        <div class="image">
          <img src="<?=$item_row->product_m_image?>" alt="" style="min-height:88px; height:50px;"/>
          <input type="hidden" name="item_img" value="<?=$item_row->product_m_image?>">
        </div>
